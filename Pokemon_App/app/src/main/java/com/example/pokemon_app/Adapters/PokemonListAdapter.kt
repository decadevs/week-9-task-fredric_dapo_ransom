package com.example.pokemon_app.Adapters
...
import com.example.pokemon_app.PokemonList
import com.example.pokemon_app.R

class PokemonListAdapter(private var context: Context, private var pokemonList: List<Pokemon>):
